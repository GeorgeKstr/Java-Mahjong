...
"άλλο γειτονικό πλακίδιο που να βρίσκεται στα αριστερά ή στα δεξιά του.";
    ...
    private void addMenus(){            
        ...
        JMenuItem aboutus = new JMenuItem("About me");
        aboutus.addActionListener((ActionEvent ev) -> {
            JOptionPane.showMessageDialog(this, "George Kiriakidis\nGeorgeKstr@gmail.com", "About me", JOptionPane.INFORMATION_MESSAGE);
        });
